...
let API_ROOT = "/api/test/controllerOptions/read_only/all/";

/**
 * All fields are read only, we will send false for both fields,
 * and expect true for both fields in return.
 */
const defaultTest = {
